...
def OCBA_method(k, mean, var, T, n_0=5, tri_del=1):
    ...
    for replications in range(0,multi):
        ...
        for l in to_not_do[0]:
            mean_new[l] = mean_initial[l]
            var_new[l] = var_initial[l]
...
OCBA_method_target_PCS(5, example_mean, example_var)
            
k = 500

n_0_equals_5 = np.zeros(k)
for i in range(0,k):
    n_0_equals_5[i] = OCBA_method_target_PCS(5, example_mean, example_var)
print(n_0_equals_5.mean())

n_0_equals_4 = np.zeros(k)
for i in range(0,k):
    n_0_equals_4[i] = OCBA_method_target_PCS(5, example_mean, example_var, n_0=4)
print(n_0_equals_4.mean())

n_0_equals_3 = np.zeros(k)
for i in range(0,k):
    n_0_equals_3[i] = OCBA_method_target_PCS(5, example_mean, example_var, n_0=3)
print(n_0_equals_3.mean())

n_0_equals_2 = np.zeros(k)
for i in range(0,k):
    n_0_equals_2[i] = OCBA_method_target_PCS(5, example_mean, example_var, n_0=2)
